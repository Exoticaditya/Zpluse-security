...
public class GuardController {
  ...
  @GetMapping("/detailed")
  @PreAuthorize("hasAnyRole('ADMIN', 'SUPERVISOR')")
  public ApiResponse<List<GuardDetailResponseDTO>> getAllGuardsDetailed(@AuthenticationPrincipal UserPrincipal principal) {
    List<GuardDetailResponseDTO> guards = guardService.getAllGuardsDetailed(principal);
    return ApiResponse.success(guards);
  }

  @GetMapping("/me")
  @PreAuthorize("hasRole('GUARD')")
  public ApiResponse<GuardDetailResponseDTO> getCurrentGuard(@AuthenticationPrincipal UserPrincipal principal) {
    GuardDetailResponseDTO guard = guardService.getCurrentGuardDetails(principal);
